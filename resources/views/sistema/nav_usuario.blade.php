    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <img src="{{asset('archivos/'.Session::get('sesionimg'))}}" width="30" height="30" alt="{{asset('archivos/'.Session::get('sesionimg'))}}"> {{Session::get('sesionname')}} <i class="fa fa-caret-down"></i>
                    </a>

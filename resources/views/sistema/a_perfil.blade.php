...
<div class="container" id="cont">
	...
	<table class="table">
		<thead>
			<tr>
				<th>Acci&oacute;n</th><th>Estatus</th><th>#Doctor</th><th>Nombre</th><th>Ced. Prof.</th><th>Telefono</th><th>Correo</th><th>Contraseña</th>
			</tr>
		</thead>
		...
		<tbody>
			<tr class="info">
				...
				<td>{{$datos->cedula}}</td><td>{{$datos->tel}}</td><td>{{$datos->correo}}</td><td>{{$datos->pass}}</td>
			</tr>      
		</tbody>
		@endforeach
	</table>
